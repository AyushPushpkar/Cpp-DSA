...
int numEnclaves( vector<vector<int>> &grid){   // tc : o(n) + o(m) + o(n*m*4)
    int n = grid.size() ;
...
// num of land cells from which one can't move out of boundary

int main(){

    vector<vector<int>> grid = {
        {1, 1, 1, 1, 0},    //1 -> sea cell 
        {1, 0, 0, 0, 1},    //0 -> land cell
        {1, 0, 1, 1, 1},  
        {1, 1, 1, 0, 0}
    };
